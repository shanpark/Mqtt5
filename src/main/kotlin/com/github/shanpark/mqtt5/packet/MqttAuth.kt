...
class MqttAuth(flags: Int = 0, remainingLength: Int = -1): com.github.shanpark.mqtt5.packet.MqttFixedHeader(MqttPacketType.AUTH, flags, remainingLength) {
    ...
    override fun calcLength(): Int {
        ...
        return  OneByteInteger.length(authReasonCode.code) +
