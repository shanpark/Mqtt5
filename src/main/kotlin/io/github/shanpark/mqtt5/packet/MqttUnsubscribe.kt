...
class MqttUnsubscribe(flags: Int, remainingLength: Int = -1): MqttFixedHeader(MqttPacketType.UNSUBSCRIBE, flags, remainingLength) {

    var packetId: Int = 0
    var properties = MqttProperties.EMPTY
    var topicFilters = mutableListOf<String>()
